...
#include "saltfish/gutil/atomicops.h"
#include "saltfish/gutil/macros.h"
#include "saltfish/gutil/threading/thread_collision_warner.h"
...
class RefCountedData
    : public saltfish::RefCountedThreadSafe< saltfish::RefCountedData<T> > {
 public:
  RefCountedData() : data() {}
 ...
 private:
  friend class saltfish::RefCountedThreadSafe<saltfish::RefCountedData<T> >;
  ~RefCountedData() {}
};
...
// The following is disabled in Saltfish's version of this file since it's
