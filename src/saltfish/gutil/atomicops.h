...
#include "saltfish/gutil/arm_instruction_set_select.h"

// ThreadSanitizer provides own implementation of atomicops.
#if defined(THREAD_SANITIZER)
#include "saltfish/gutil/atomicops-internals-tsan.h" // IWYU pragma: export
#elif defined(__APPLE__)
#include "saltfish/gutil/atomicops-internals-macosx.h" // IWYU pragma: export
#elif defined(__GNUC__) && defined(ARMV6)
#include "saltfish/gutil/auxiliary/atomicops-internals-arm-v6plus.h" // IWYU pragma: export
#elif defined(ARMV3)
#include "saltfish/gutil/auxiliary/atomicops-internals-arm-generic.h" // IWYU pragma: export
#elif defined(__GNUC__) && (defined(__i386) || defined(__x86_64__))
#include "saltfish/gutil/atomicops-internals-x86.h" // IWYU pragma: export
#elif defined(__GNUC__) && defined(__powerpc64__)
#include "saltfish/gutil/atomicops-internals-powerpc.h" // IWYU pragma: export
#elif defined(OS_WINDOWS)
#include "saltfish/gutil/auxiliary/atomicops-internals-windows.h" // IWYU pragma: export
#elif defined(__GNUC__) && defined(__aarch64__)
#include "saltfish/gutil/atomicops-internals-arm64.h" // IWYU pragma: export
#else
