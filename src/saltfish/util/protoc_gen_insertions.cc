...
#include "saltfish//gutil/strings/substitute.h"
...
static const char* const kIncludeToInsert = "#include \"saltfish/util/protobuf-annotations.h\"\n";
...
int main(int argc, char *argv[]) {
  saltfish::InsertAnnotations generator;
